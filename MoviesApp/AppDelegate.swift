...
//    var window: UIWindow?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if isLoggedIn {
            let moviesTableVC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "moviesTableVC") as! MoviesTableViewController
//            self.window?.rootViewController = moviesTableVC
